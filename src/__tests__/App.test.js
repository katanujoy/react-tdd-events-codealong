...
test("pizza checkbox is initially unchecked", () => {
  ...
  expect(addPepperoni).not.toBeChecked(); // This will now work if jest-dom is properly set up
});
...
test("toppings list initially contains only cheese", () => {
  ...
  expect(screen.getByText("Cheese")).toBeInTheDocument(); // This will now work if jest-dom is properly set up
